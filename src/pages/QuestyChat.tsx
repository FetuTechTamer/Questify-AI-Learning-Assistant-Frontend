...
const QuestyChat = () => {
  ...
  const handleSend = async (retryCount = 0) => {
    ...
    try {
      ...
      // If session expired (404), re-create and retry once
      ...
      const errorText =
        error.response?.status === 404
          ? 'No chat session available. Please try again.'
            ...
            {messages.length === 0 && !activeSessionId ? (
              ...
              >
                ...
                <p className="text-muted-foreground max-w-sm mb-8 lg:mb-12 text-sm lg:text-base leading-relaxed">
                  Your AI study partner. Ask me anything — concepts, strategies, summaries, or exam tips. I'm here to help you learn.
                </p>
